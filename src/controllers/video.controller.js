...
const getAllVideos = asyncHandler(async (req, res) => {
    ...
    if(query) //this takes the query for search given by the user
   {
    pipeline.push({ //once you find videos whose title or description matches the query add them to pipeline array
        $search:{
